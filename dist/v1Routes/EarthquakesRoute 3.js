...
var earthquakesRouter = _express2.default.Router();

earthquakesRouter.route('/').get(function () {
			...
			while (1) {
				switch (_context.prev = _context.next) {
					...
					case 5:
						...
						_context.next = 8;
						return mclient.db(_paths2.default.natural_disasters_db_str).collection("earthquakes");

					case 8:
						collection = _context.sent;
						_context.next = 11;
						return mclient.db(_paths2.default.natural_disasters_db_str).listCollections({ name: "earthquakes" }).hasNext();
	...
	function getEarthquakes(_x, _x2, _x3) {
...
exports.default = earthquakesRouter;